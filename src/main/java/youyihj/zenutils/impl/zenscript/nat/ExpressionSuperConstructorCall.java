 ...
 * @author youyihj
 */
public class ExpressionSuperConstructorCall extends Expression {
    private final ExecutableData constructor;
    private final IEnvironmentGlobal environment;
    private final Expression[] arguments;

    public ExpressionSuperConstructorCall(ZenPosition position, ExecutableData constructor, IEnvironmentGlobal environment, Expression[] arguments) {
        super(position);
