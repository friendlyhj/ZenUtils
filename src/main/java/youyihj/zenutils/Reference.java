...
public class Reference {
    ...
    public static final String VERSION = "1.28.2.1";
    public static final String DEPENDENCIES = "required-after:crafttweaker;required-after:mixinbooter@[11.5,);required-after:configanytime;before:contenttweaker;after:ftbquests;";
