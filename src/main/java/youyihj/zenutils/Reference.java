...
public class Reference {
    ...
    public static final String VERSION = "1.25.11";
    public static final String DEPENDENCIES = "required-after:crafttweaker;required-after:mixinbooter@[10.7,);required-after:configanytime;before:contenttweaker;after:ftbquests;";
